...
# ==================== CONFIG ====================
BOT_TOKEN = "8664037209:AAHqed22av7jo2n6hVTEapArSMqt7eNbR8sx"  # NEW TOKEN
ADMIN_ID = 7500110150
...
def stop_bomber_callback(call):
    # Bomber is disabled – just reply with the disabled message
...
def handle_all(message):
    ...
    # Map of menu texts to action names (all in lowercase)
    menu_map_lower = {
        "bot owner": "owner",
    ...
    # ==================== No Searches Left Check (skip for promo and bomber) ====================
    if user_id != ADMIN_ID and user_id != PARTNER_ID:
